...
DefaultProperties
{
    PickupClass=Class'UTCompCTF.NewNet_RocketLauncherPickup'
    FireModeClass(0)=class'UTCompCTF.NewNet_RocketFire'
    FireModeClass(1)=class'UTCompCTF.NewNet_RocketMultiFire'
}
