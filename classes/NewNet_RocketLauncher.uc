...
DefaultProperties
{
    PickupClass=Class'UTCompCTFv01.NewNet_RocketLauncherPickup'
    FireModeClass(0)=class'UTCompCTFv01.NewNet_RocketFire'
    FireModeClass(1)=class'UTCompCTFv01.NewNet_RocketMultiFire'
}
