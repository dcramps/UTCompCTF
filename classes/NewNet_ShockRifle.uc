...
DefaultProperties
{
    FireModeClass(0)=class'UTCompCTF.NewNet_ShockBeamFire'
    FireModeClass(1)=class'UTCompCTF.NewNet_ShockProjFire'
    PickupClass=Class'UTCompCTF.NewNet_ShockRiflePickup'
}
