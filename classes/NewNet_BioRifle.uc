...
DefaultProperties
{
    FireModeClass(0)=class'UTCompCTFv01.NewNet_BioFire'
    FireModeClass(1)=class'UTCompCTFv01.NewNet_BioChargedFire'
    PickupClass=Class'UTCompCTFv01.NewNet_BioRiflePickup'
}
