...
defaultproperties
{
   ...
   Begin Object class=moCheckBox name=SizeIncreaseCheck
    ...
    UTCompNewHairs(0)=(xHairName="Big Circle(0)",xHairTexture=Texture'UTCompCTF.BigCircle')
    UTCompNewHairs(1)=(xHairName="Big Circle(1)",xHairTexture=Texture'UTCompCTF.MedCircle')
    UTCompNewHairs(2)=(xHairName="Big Circle(2)",xHairTexture=Texture'UTCompCTF.SmallCircle')
    UTCompNewHairs(3)=(xHairName="Big Circle(3)",xHairTexture=Texture'UTCompCTF.UberSmallCircle')

    UTCompNewHairs(4)=(xHairName="Small Circle(0)",xHairTexture=Texture'UTCompCTF.BigCircle_2')
    UTCompNewHairs(5)=(xHairName="Small Circle(1)",xHairTexture=Texture'UTCompCTF.MedCircle_2')
    UTCompNewHairs(6)=(xHairName="Small Circle(2)",xHairTexture=Texture'UTCompCTF.SmallCircle_2')
    UTCompNewHairs(7)=(xHairName="Small Circle(3)",xHairTexture=Texture'UTCompCTF.UberSmallCircle_2')

    UTCompNewHairs(8)=(xHairName="Big Square(0)",xHairTexture=Texture'UTCompCTF.BigSquare')
    UTCompNewHairs(9)=(xHairName="Big Square(1)",xHairTexture=Texture'UTCompCTF.BigSquare_2')
    UTCompNewHairs(10)=(xHairName="Big Square(2)",xHairTexture=Texture'UTCompCTF.BigSquare_3')

    UTCompNewHairs(11)=(xHairName="Big diamond(0)",xHairTexture=Texture'UTCompCTF.Bigdiamond')
    UTCompNewHairs(12)=(xHairName="Big Diamond(1)",xHairTexture=Texture'UTCompCTF.Bigdiamond_2')
    UTCompNewHairs(13)=(xHairName="Big Diamond(2)",xHairTexture=Texture'UTCompCTF.Bigdiamond_3')

    UTCompNewHairs(14)=(xHairName="Big Horiz",xHairTexture=Texture'UTCompCTF.SmallVert')
    UTCompNewHairs(15)=(xHairName="Small Horiz",xHairTexture=Texture'UTCompCTF.BigVert')
    UTCompNewHairs(16)=(xHairName="Big Vert",xHairTexture=Texture'UTCompCTF.SmallHoriz')
    UTCompNewHairs(17)=(xHairName="Small Vert",xHairTexture=Texture'UTCompCTF.BigHoriz')

    UTCompNewHairs(18)=(xHairName="Big 'L'(0)",xHairTexture=Texture'UTCompCTF.BigBracket')
    UTCompNewHairs(19)=(xHairName="Big 'L'(1)",xHairTexture=Texture'UTCompCTF.BigBracket_1')
    UTCompNewHairs(20)=(xHairName="Big 'L'(2)",xHairTexture=Texture'UTCompCTF.BigBracket_2')
    UTCompNewHairs(21)=(xHairName="Big 'L'(3)",xHairTexture=Texture'UTCompCTF.BigBracket_3')
    UTCompNewHairs(22)=(xHairName="Big 'L'(4)",xHairTexture=Texture'UTCompCTF.BigBracket_4')
    UTCompNewHairs(23)=(xHairName="Big 'L'(5)",xHairTexture=Texture'UTCompCTF.BigBracket_5')
    UTCompNewHairs(24)=(xHairName="Big 'L'(6)",xHairTexture=Texture'UTCompCTF.BigBracket_6')
    UTCompNewHairs(25)=(xHairName="Big 'L'(7)",xHairTexture=Texture'UTCompCTF.BigBracket_7')
